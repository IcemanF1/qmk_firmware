...
#define MATRIX_ROW_PINS { B3, F1, F4, F5, F6, F7 } //Rotary encoder SPST is on F0,F7
...
#define RGB_DI_PIN B0
	...
	#define DRIVER_LED_TOTAL 32 // The number of LEDs connected for matrix, 17 key + 11 underglow
